...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile Zib MedicationUse
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationStatement">
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicationUse-AsAgreedIndicator']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicationUse-AsAgreedIndicator': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicationUse-Prescriber']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicationUse-Prescriber': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicationUse-Author']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicationUse-Author': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-Medication-MedicationTreatment']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/zib-Medication-MedicationTreatment': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:MedicationStatement/f:effective[x]/f:extension 1</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:MedicationStatement/f:dosage/f:dose[x] 1</sch:title>
