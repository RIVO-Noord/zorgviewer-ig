...
<tr>
<td>Rol</td>
<td><samp>relationship.where(coding.system='urn:oid:2.16.840.1.113883.2.4.3.11.22.472' or coding.system='http://terminology.hl7.org/CodeSystem/v3-RoleClass' or coding.system='http://terminology.hl7.org/CodeSystem/v2-0131').select(text | coding.display)</samp></td>
<td><code>string</code></td>
<td>Rol</td>
<td></td>
</tr>
...
<td>+Adres</td>
<td><samp>address.line.select(iif(getValue().exists(), getValue(), extension.value.join(' '))) + ' ' +  address.postalCode + ' ' + address.city</samp></td>
<td><code>string</code></td>
