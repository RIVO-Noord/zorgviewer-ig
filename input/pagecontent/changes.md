...
|---|---|---|
|0.9.0-CIbuild|current|[Detail wijzigingen](https://github.com/RIVO-Noord/zorgviewer-ig/compare/0.8.0-sprint9...master)<br/>* Labuitslagen tweede draft<br/>* Toestemming mappings van HL7 v2 CON|
