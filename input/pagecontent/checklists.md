...
* 3.4 Om te voorkomen dat onterecht een werkdiagnose (die wel in problemlijst mee komen) op "confirmed" worden gezet, moet de FHIR PROFILE variabele ingesteld worden: FHIR_NL_PROBLEM_SHOW_VERIFY_STATUS = 0 (Nee) 
